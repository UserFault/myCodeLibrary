...
namespace MyCodeLibrary.ShellLinkTwo
{
    ...
    string pszFileName, uint dwMode);
        ...
        public static string ResolveShortcut(string filename)
        {
            ...
            // TODO: если у меня есть hwnd окна, можно вызвать Resolve() сначала. Это обрабатывает перемещенные или переименованные файлы.  
