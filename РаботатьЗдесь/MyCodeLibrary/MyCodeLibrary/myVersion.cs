...
namespace MyCodeLibrary
{
    ...
    public class myVersion
    {
        ...
        /// </remarks>
        /// <returns></returns>
        public bool IsEquivalentVersion(myVersion ver)
        {
        ...
        /// </remarks>
        /// <returns></returns>
        public bool IsCompatibleVersion(myVersion ver)
        {
            if (m_MainVersion != ver.m_MainVersion) return false;
            if (m_SubVersion != ver.m_SubVersion) return false;
            return true;
        ...
        public bool Parse(String versionString)
        {
            ...
            try
            {
                ...
                m_MainVersion = Int32.Parse(sar[0], CultureInfo.InvariantCulture);
                m_SubVersion = Int32.Parse(sar[1], CultureInfo.InvariantCulture);
                m_PatchNumber = Int32.Parse(sar[2], CultureInfo.InvariantCulture);
                m_BuildNumber = Int32.Parse(sar[3], CultureInfo.InvariantCulture);
            }
            catch (Exception)
            {
                result = false;
